...
const TOOLS = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Find marketing/sales contacts at a company via Apollo (departments: Marketing; Sales → Business Development & Partnerships; verified email only; auto-fallback to any verified contact). Creates pending CRM contacts — user must Reveal in UI for emails (credits). Never auto-reveal.",
      parameters: {
        type: "object",
        properties: {
